...
ALTER TABLE "applications" ADD COLUMN "created_at" timestamp DEFAULT now() NOT NULL;
...
ALTER TABLE "applications" DROP COLUMN IF EXISTS "createdAt";
ALTER TABLE "applications" DROP COLUMN IF EXISTS "updatedAt";